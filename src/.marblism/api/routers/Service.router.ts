...
export default function createRouter<Config extends BaseConfig>(router: RouterFactory<Config>, procedure: ProcBuilder<Config>) {
    return router({
        ...
        createMany: procedure.input($Schema.ServiceInputSchema.createMany).mutation(async ({ ctx, input }) => checkMutate(db(ctx).service.createMany(input as any))),
        ...
        deleteMany: procedure.input($Schema.ServiceInputSchema.deleteMany).mutation(async ({ ctx, input }) => checkMutate(db(ctx).service.deleteMany(input as any))),
        ...
        findFirst: procedure.input($Schema.ServiceInputSchema.findFirst).query(({ ctx, input }) => checkRead(db(ctx).service.findFirst(input as any))),

        findMany: procedure.input($Schema.ServiceInputSchema.findMany).query(({ ctx, input }) => checkRead(db(ctx).service.findMany(input as any))),
